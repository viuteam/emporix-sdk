...
- [#335](https://github.com/viuteam/emporix-sdk/pull/335) [`a2e1e96`](https://github.com/viuteam/emporix-sdk/commit/a2e1e96e706265176b37b8355cd6a6213588e8ef) Thanks [@amnael1](https://github.com/amnael1)! - feat(sdk): add media.patch and ai.reuseAttachment, and document the product mixin merge
...
- [#330](https://github.com/viuteam/emporix-sdk/pull/330) [`016e339`](https://github.com/viuteam/emporix-sdk/commit/016e339c21957504d0b1842fdfcc540c0d9afac1) Thanks [@amnael1](https://github.com/amnael1)! - feat(sdk): forward sort on listReindexJobs and document the BATTERY_INCLUDED credential validation
...
- [#329](https://github.com/viuteam/emporix-sdk/pull/329) [`4ba3017`](https://github.com/viuteam/emporix-sdk/commit/4ba301702ad1396324c252df2a1bbc41762481cc) Thanks [@viu-release-bot](https://github.com/apps/viu-release-bot)! - chore(sdk): sync generated types with upstream Emporix API specs
...
- [#325](https://github.com/viuteam/emporix-sdk/pull/325) [`10dc05f`](https://github.com/viuteam/emporix-sdk/commit/10dc05fb1faef990d45ff94615dfe745852165f9) Thanks [@viu-release-bot](https://github.com/apps/viu-release-bot)! - chore(sdk): sync generated types with upstream Emporix API specs
...
- [#320](https://github.com/viuteam/emporix-sdk/pull/320) [`5ec1c0b`](https://github.com/viuteam/emporix-sdk/commit/5ec1c0b1876679d381a48a43b8571309224d7c3a) Thanks [@amnael1](https://github.com/amnael1)! - feat(sdk): add import deleteSchedule and document the new run fields
  ...
  - `triggerRun` accepts `sampleSize` (dry-run only, 1–100, default 25) and the
    run comes back with `dryRunSample`: the mapped records the import _would_ have
    written, so a mapping can be previewed without one. Absent on a normal run.
  - `triggerRun` accepts `origin`, free text naming _what_ asked for the run, and
...
- [#319](https://github.com/viuteam/emporix-sdk/pull/319) [`86d2f64`](https://github.com/viuteam/emporix-sdk/commit/86d2f64843980169ccb9c522f6f50184057c5f64) Thanks [@viu-release-bot](https://github.com/apps/viu-release-bot)! - chore(sdk): sync generated types with upstream Emporix API specs
...
- [#317](https://github.com/viuteam/emporix-sdk/pull/317) [`f080b84`](https://github.com/viuteam/emporix-sdk/commit/f080b84d6dc9ccd97c596ba7f6c99619d49a849d) Thanks [@viu-release-bot](https://github.com/apps/viu-release-bot)! - chore(sdk): sync generated types with upstream Emporix API specs
...
- [#314](https://github.com/viuteam/emporix-sdk/pull/314) [`f877f94`](https://github.com/viuteam/emporix-sdk/commit/f877f949ffea4ccf5242ecea34bf9e0596bef4a5) Thanks [@amnael1](https://github.com/amnael1)! - feat(sdk): add the audit log (changelog) service
...
- [#312](https://github.com/viuteam/emporix-sdk/pull/312) [`bd78d7b`](https://github.com/viuteam/emporix-sdk/commit/bd78d7bb77b22df12f32f9d9f6289058183cddb2) Thanks [@viu-release-bot](https://github.com/apps/viu-release-bot)! - chore(sdk): sync generated types with upstream Emporix API specs
...
- [#311](https://github.com/viuteam/emporix-sdk/pull/311) [`93816b2`](https://github.com/viuteam/emporix-sdk/commit/93816b231b01babfbbf42704279bcd53809462fe) Thanks [@amnael1](https://github.com/amnael1)! - feat(sdk): add the import analytics reads and failed-record retry
  ...
  **`retryRun` returns a new run**, not a mutated original: its `id` differs and
  ...
  Nothing was needed for the seven endpoints the same release _changed_. This
