 ...
 * List of prices
 */
export type Prices = Array<GetPrice>;
 ...
 * Measurement unit for which the price is defined.
 */
export type MatchMeasurementUnit = {
    /**
     * Quantity of the measurement unit.
     */
    quantity: number;
...
/**
 * Price matching (by session context) request body
 */
export type MatchByContext = {
    ...
    items?: Array<{
        ...
        quantity?: MatchMeasurementUnit;
    }>;
};

/**
 * Price matching (by criteria) request body
 */
export type Match = {
    /**
...
export type GetSinglePrice = GetPrice & {
    priceModel?: PriceModelExpand;
};

export type UpdatePrice = GetSinglePrice & {
    metadata?: PriceMetadata;
};
