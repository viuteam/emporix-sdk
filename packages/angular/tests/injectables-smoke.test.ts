...
const guestReads: Array<{
  ...
  { name: "injectProductSearch", resource: "product-name-search", run: () => I.injectProductSearch(signal("shoe")), called: () => client.products.searchByName },
  { name: "injectProductQuery", resource: "product-search", run: () => I.injectProductQuery(signal("name:x" as never), signal({})), called: () => client.products.search },
