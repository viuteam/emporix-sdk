...
- [#307](https://github.com/viuteam/emporix-sdk/pull/307) [`3f750e2`](https://github.com/viuteam/emporix-sdk/commit/3f750e23f8ba077cfb24ed5a067d2b9021f212b9) Thanks [@amnael1](https://github.com/amnael1)! - feat(react): export the query factory so consumers can wrap back-office operations
  ...
  **Why:** the hooks here cover the storefront, which is roughly a quarter of the
  ...
  A **Managed Dashboard** module is the case where that token _can_. The host passes
