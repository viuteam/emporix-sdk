...
|---|---|---|
| `packages/sdk` | Core SDK: HTTP, auth, services (Product, Category, Cart, Checkout, Customer, Payment, Price, Media, Segment, Site, SessionContext, Companies, Contacts, Locations, CustomerGroups, TenantConfig, ClientConfig, ShoppingList, RagIndexer, SequentialId) | yes (`@viu/emporix-sdk`) |
