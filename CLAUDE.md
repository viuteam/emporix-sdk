...
| `packages/angular` | Angular bindings: `provideEmporix`, signal-based `inject*` over TanStack Query, site + customer session. **Decorator-free by rule** so it builds with tsup, not `ng-packagr` | yes (`@viu/emporix-sdk-angular`) |
